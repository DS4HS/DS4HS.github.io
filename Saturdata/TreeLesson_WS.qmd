...
In this worksheet, you’ll practice writing **tidyverse-style R code** for data wrangling tasks. Each question guides you through filtering, selecting, mutating, and summarizing a the `ca_tes` dataset. 
