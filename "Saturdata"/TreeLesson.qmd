...
> Focus on tree coverage, TES, and unemployment (keep these columns)
...
ca_tes |>
  filter(!is.na(pctpov), !is.na(health_nor)) |>
...
-   Communicate Results **Clearly** and **Effectivley**
...
-   Work in small groups to investigate tree equity in a new state(s)
-   Each Group Will:
...
-   Download the data for the state(s) you plan to research as a .csv file

-   then in R studio:

    -   Create a new .qmd file titled "DS4HS_Presentation"
